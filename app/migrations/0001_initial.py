    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('concert', 'Âm nhạc'), ('theater', 'Sân khấu & Nghệ Thuật'), ('sports', 'Thể thao'), ('conference', ''), ('other', 'Khác')], default='other', max_length=20, verbose_name='Thể loại')),
